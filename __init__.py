...
class CarControlExample(MycroftSkill):
    ...
    def initialize(self):
        ...
        ### handling messages
        self.add_event('enclosure.mouth.text',
                self.send_enclosure_text)

    def send_enclosure_text(self):
        pass
    ...
    def handle_start_loading(self, message):
        percent = message.data.get("speed", "100")
    ...
    def handle_temperature_up(self, message):
        temperatur = message.data.get("position", "20")
    ...
    def handle_set_cruise_control(self, message):
        speed = message.data.get("speed", "120")
    ...
    def handle_set_leds(self, message):
        color = message.data.get("color", "red")
